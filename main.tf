...
module "opensearch_serverless" {
  ...
  create_security_config      = var.create_security_config
  security_config_name        = var.security_config_name
  ingress_rules               = var.ingress_rules
  egress_rules                = var.egress_rules
  vpc_create_security_group   = var.vpc_create_security_group
  vpc_security_group_name     = var.vpc_security_group_name
  network_policy_type         = var.network_policy_type
  encryption_policy_kms_key_arn = var.encryption_policy_kms_key_arn
  create_public_access        = var.create_public_access
  create_private_access       = var.create_private_access
